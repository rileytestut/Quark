...
@property (strong, nonatomic) id linkEnabledSwitch;
...
- (void)viewDidLoad
{
    ...
    self.peerType = [[NSUserDefaults standardUserDefaults] integerForKey:@"peerType"];
...
- (void)setPeerType:(GBALinkPeerType)peerType
{
    ...
    [[NSUserDefaults standardUserDefaults] setInteger:peerType forKey:@"peerType"];
